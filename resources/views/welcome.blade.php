                        ...
                        <div class="wrapper">
                            <div class="uofb cf">
                                <div class="l_col adrs">
                                    ...
                                    <form action="/TestTask/public/post" method="post">
                                        @csrf
                                        <div class="field">
                                            <label>Name *</label>
                                            <input type="text" value="" placeholder="" ceholder="" class="vl_empty" name="name" />
                                        </div>
                                        <div class="field">
                                ...
                                <div class="r_col">
                                    ...
                                    <div class="uo_adr_list">
                                        @foreach($posts as $post)
                                            <div class="item">
                                                <h3>{{$post->name}}</h3>
                                                <p>{{$post->city}} {{$post->area}} {{$post->street}} {{$post->house}} {{$post->description}} </p>
                                                <div class="actbox">
